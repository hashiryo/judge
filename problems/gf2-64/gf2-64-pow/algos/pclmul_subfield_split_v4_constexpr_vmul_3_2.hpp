...
u64 pow(u64 a, u64 e) {
 ...
 u64 T[16]= {1, a};
 mul2(_mm256_set1_epi64x(a), _mm256_set_epi64x(0, frob32(a), 0, a), T[2], T[0]);
 ...
 mul2(_mm256_set_epi64x(0, frob16(T[0]), 0, T[7]), _mm256_set_epi64x(0, T[0], 0, T[8]), T[15], T[0]);
 ...
 const u64 b= embed_idx(TABLES.PW_SIGMA_IDX[(u32(TABLES.LN_SIGMA[u16(T[0])]) * q) % 65535]);
 return mul(b, g);
}
}  // namespace gf2_64_pow_subfield_split_v4_7
struct GF2_64Op {
