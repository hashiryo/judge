...
[[gnu::target("pclmul")]] u64 combine_crt(u32 r1, u32 r0, u32 r2, u32 r3) {
...
[[gnu::target("pclmul")]] void log_g_batch4(const u64 xs[4], u64 results[4]) {
...
[[gnu::target("pclmul")]] u64 log_g_single(u64 x) {
