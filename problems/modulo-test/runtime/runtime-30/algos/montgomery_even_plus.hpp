...
private:
 ...
 constexpr inline u32 reduce(u64 w) const { return (w + (((w * iv1) & mask) * mo)) >> 32; }
 constexpr inline u32 transform(u32 n) const { return (u64(n) * r2 + (((n * iv2) & mask) * mo)) >> 32; }
};
