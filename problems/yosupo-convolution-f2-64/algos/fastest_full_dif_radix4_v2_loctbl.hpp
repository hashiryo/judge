...
namespace conv_f2_64_full_dif_radix4_v2_loctbl {
...
inline const __m256i RED_TABLE_DIF_R4V2L= _mm256_setr_epi8(
...
VPCLMUL inline __m256i clmul_reduce_pair(__m256i a_vec, __m256i b_vec) {
 ...
 __m256i red_vec= _mm256_shuffle_epi8(RED_TABLE_DIF_R4V2L, indices);
...
struct Solver {
 VPCLMUL static std::vector<u64> run(int n, int m, const std::vector<u64>& a_in, const std::vector<u64>& b_in) {
  using namespace conv_f2_64_full_dif_radix4_v2_loctbl;
